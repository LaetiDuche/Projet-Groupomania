<template>
  <div class="forum">
    ...
    <div class="forum-publication formulaire mx-auto col-10 mt-4 p-3 rounded-3 shadow" v-for="(gifs, id) in gif" v-bind:key="id"><!--v-if="id"-->
      <div class="d-flex" >
        ...
        <span class=" p-1 text-center" type="text" id="username" >{{ username }}</span>

        <!--Bouton supprimer le message-->
        <div class="p-1 ms-auto" role="button" @click.prevent="btnDelete">
      ...
      <div>
        <p class="date fw-light" > {{gif.updatedAt}}</p>
      </div>
      ...
      <div class="m-1 ">
        ...
        <button @click="btnClick += 1, click= !click" class="btn-like bg-transparent border-0  py-auto d-flex text-align" type="submit">

         <!--Si liker-->
        <svg v-if="click === true" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
        ...
        <!--Si pas liker-->
        <svg v-else xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
